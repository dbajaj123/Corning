...
� **Corning Future Innovation Program 2025 Finalist Project**
...
Corning/
├── README.md                                    # This file
├── PINNS_Temperature_Interpolation_Analysis.ipynb  # Main implementation notebook
├── trained_pinn_model.pth                      # Trained model (ready for deployment)
├── ps1_dataA_15TC.csv                          # Sparse sensor data (15 thermocouples)
├── ps1_dataA_120TC.csv                         # Dense sensor data (120 thermocouples)
├── model.py                                    # Standalone model code
├── Documentation/
│   ├── PINNS_Abstract_Corning_2025.md         # Technical abstract
│   ├── PINNS_Technical_Approach_Detailed.md   # Detailed methodology
│   └── Temperature_Interpolation_Approaches_Comprehensive.md
└── Scripts/
    ├── create_comprehensive_document.py        # Documentation generator
    ├── create_html_document.py                # HTML report generator
    └── generate_approaches_pdf.py             # PDF documentation
```
